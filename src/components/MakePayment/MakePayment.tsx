...
} from "../CreateCardModal/CreateCardModal.types";
...
export function MakePayment(): JSX.Element {
  ...
  const submitHandler = async (): Promise<void> => {
    ...
    try {
      ...
      const sourceDetails = {
        id: "bc2042a9-1192-470b-9f46-280a3a2c6724",
        type: "card",
      };
      const payload: CreateCardPaymentPayload = {
        ...
        verificationFailureUrl: "https://amazon.com",
        metadata: {
      ...
      const cardRes = await createPayment(payload);
